...
const processes = [
  { step: '', title: 'STRATEGY', desc: 'Defining the digital roadmap for your brand. We analyze market trends and user behavior.', color: '#111111' },
  { step: '', title: 'DESIGN', desc: 'Crafting interfaces that feel like magic. Focus on aesthetics and seamless usability.', color: '#1a1a1a' },
  { step: '', title: 'DEVELOP', desc: 'High-performance code that scales. Using the latest tech stack for speed.', color: '#222222' },
  { step: '', title: 'LAUNCH', desc: 'Deploying excellence to the world. Quality assurance and final optimization.', color: '#2a2a2a' }
];

const InsightPageScroll = () => {
  return (
  ...
  <div className="stack-wrapper">
    {processes.map((p, i) => (
      ...
      <style>
        ...
        .stack-wrapper {
  position: relative;
  height: 250vh; /* 👈 THIS creates scroll space */
}

/* Each card sticks one after another */
.process-card {
  position: sticky;
  top: 120px;   /* 👈 controls where it sticks */
  margin: 0 auto;
  max-width: 600px;
...
export default InsightPageScroll;