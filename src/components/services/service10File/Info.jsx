  ...
  return (
    <div className="container">
      ...
      <div className="media-section">
        <div className="box"><video src="https://framerusercontent.com/assets/XzKm3c6TBPnQY2RLiGOpjE83OU0.mp4" autoPlay loop muted playsInline /></div>
        <div className="box"><video src="https://framerusercontent.com/assets/LqHnLVpPrDaiM1FZ63ODyW25jaw.mp4" autoPlay loop muted playsInline /></div>
        <div className="box"><video src="https://framerusercontent.com/assets/hQUXKbpvYZyElXRxbNmW95ph8Q.mp4" autoPlay loop muted playsInline /></div>
      </div>
